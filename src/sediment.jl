### Soil erosion ###
@get_units @bmi_land_grid @with_kw struct LandSediment{T}
    # number of cells
    n::Int | "-" | 6
    ### Soil erosion part ###
...
@get_units @bmi_land_grid @with_kw struct OverlandFlowSediment{T}
    # number of cells
    n::Int | "-" | 6
    # Filter with river cells
    rivcell::Vector{T} | "-"
...
@get_units @bmi_river_grid @with_kw struct RiverSediment{T}
    # number of cells
    n::Int | "-" | 6
    # Timestep [s]
    Δt::T | "s" | 6
